    ...
    public partial class Cart : Form
    {
        ...
        public void add_dish()
        {
            ...
            else if (check_upt == 3)
            {
                ...
                int Quantity;
                int final_price;
                Int32.TryParse(Quantity3.Text, out Quantity);
                string Price = Add_Cart.instance1.label_Price.Text;
                Int32.TryParse(Price, out final_price);
                final_price = Quantity * final_price;
        ...
        private void button_placeorder_Click(object sender, EventArgs e)
        {
            ...
            else if (Dish1.Text == "Pomodoro Pasta")
            {
                string d1 = "Pasta";
                string d2 = "White Sauce";
                string d3 = "Vaults Secret Sauce";
                ...
                quantity_final("10", d1, q1.ToString());
                quantity_final("11", d2, q2.ToString());
                quantity_final("9", d3, q3.ToString());
                
            }
            else if (Dish1.Text == "Korean Fried Chicken")
            {
                string d1 = "Chicken Patty";
                string d2 = "Korean Spices";
                string d3 = "Lettuce";
                ...
                quantity_final("1", d1, q1.ToString());
                quantity_final("12", d2, q2.ToString());
                quantity_final("4", d3, q3.ToString());
            }
            else if (Dish1.Text == "Sicilian Pizza")
            {
                string d1 = "Flour";
                string d2 = "Cheese Sauce";
                string d3 = "Vaults Secret Sauce";
                string d4 = "Onion Ring";
                string d5 = "Chicken Patty";
                string d6 = "Olives";
                string d7 = "Korean Spices";
                int q1 = quantity_update(d1);
                int q2 = quantity_update(d2);
                int q3 = quantity_update(d3);
                int q4 = quantity_update(d4);
                ...
                quantity_final("13", d1, q1.ToString());
                quantity_final("5", d2, q2.ToString());
                quantity_final("9", d3, q3.ToString());
                quantity_final("8", d4, q4.ToString());
                quantity_final("1", d5, q5.ToString());
                quantity_final("14", d6, q6.ToString());
                quantity_final("12", d7, q7.ToString());
            }
            else if (Dish1.Text == "White Cheese Chicken Lasagna")
            {
                string d1 = "Chicken Patty";
                string d2 = "White Sauce";
                string d3 = "Cheese Sauce";
                string d4 = "Vaults Secret Sauce";
                ...
                quantity_final("1", d1, q1.ToString());
                quantity_final("11", d2, q2.ToString());
                quantity_final("5", d3, q3.ToString());
                quantity_final("9", d4, q4.ToString());
               
            }
            else if (Dish1.Text == "Chicken Tandoori")
            {
                string d1 = "Chicken Patty";
                string d2 = "Korean Spices";
            ...
            else if (Dish1.Text == "Margherita Pizza")
            {
                string d1 = "Beef Patty";
                string d2 = "White Sauce";
                string d3 = "Flour";
                ...
                quantity_final("7", d1, q1.ToString());
                quantity_final("11", d2, q2.ToString());
                quantity_final("13", d3, q3.ToString());
                quantity_final("9", d4, q4.ToString());
            }
            else if (Dish1.Text == "Thai Steamed Fish")
            {
                string d1 = "Fish";
                string d2 = "Korean Spices";
                ...
                quantity_final("15", d1, q1.ToString());
                quantity_final("12", d2, q2.ToString());
            }
            else if (Dish1.Text == "Chicken Reshmi Kebab")
            {
                string d1 = "Chicken Patty";
                string d2 = "Vaults Secret Sauce";
                ...
                quantity_final("1", d1, q1.ToString());
                quantity_final("9", d2, q2.ToString());
            }
            ...
            if (Dish2.Text == "Rumble Burger")
            {
                ...
                Int32.TryParse(Quantity2.Text, out q);
                q1 = q1 - q;
                q2 = q2 - q;
                q3 = q3 - q;
                q4 = q4 - q;
            ...
            else if (Dish2.Text == "Pomodoro Pasta")
            {
                string d1 = "Pasta";
                string d2 = "White Sauce";
                string d3 = "Vaults Secret Sauce";
            ...
            else if (Dish2.Text == "Korean Fried Chicken")
            {
                string d1 = "Chicken Patty";
                string d2 = "Korean Spices";
                string d3 = "Lettuce";
            ...
            else if (Dish2.Text == "Sicilian Pizza")
            {
                string d1 = "Flour";
                string d2 = "Cheese Sauce";
                string d3 = "Vaults Secret Sauce";
            ...
            else if (Dish2.Text == "White Cheese Chicken Lasagna")
            {
                string d1 = "Chicken Patty";
                string d2 = "White Sauce";
                string d3 = "Cheese Sauce";
            ...
            else if (Dish2.Text == "Chicken Tandoori")
            {
                string d1 = "Chicken Patty";
                string d2 = "Korean Spices";
            ...
            else if (Dish2.Text == "Margherita Pizza")
            {
                string d1 = "Beef Patty";
                string d2 = "White Sauce";
                string d3 = "Flour";
            ...
            else if (Dish2.Text == "Thai Steamed Fish")
            {
                string d1 = "Fish";
                string d2 = "Korean Spices";
            ...
            else if (Dish2.Text == "Chicken Reshmi Kebab")
            {
                string d1 = "Chicken Patty";
                string d2 = "Vaults Secret Sauce";
            ...
            if (Dish3.Text == "Rumble Burger")
            {
                ...
                Int32.TryParse(Quantity3.Text, out q);
                q1 = q1 - q;
                q2 = q2 - q;
                q3 = q3 - q;
                q4 = q4 - q;
            ...
            else if (Dish3.Text == "Pomodoro Pasta")
            {
                string d1 = "Pasta";
                string d2 = "White Sauce";
                string d3 = "Vaults Secret Sauce";
            ...
            else if (Dish3.Text == "Korean Fried Chicken")
            {
                string d1 = "Chicken Patty";
                string d2 = "Korean Spices";
                string d3 = "Lettuce";
            ...
            else if (Dish3.Text == "Sicilian Pizza")
            {
                string d1 = "Flour";
                string d2 = "Cheese Sauce";
                string d3 = "Vaults Secret Sauce";
            ...
            else if (Dish3.Text == "White Cheese Chicken Lasagna")
            {
                string d1 = "Chicken Patty";
                string d2 = "White Sauce";
                string d3 = "Cheese Sauce";
            ...
            else if (Dish3.Text == "Chicken Tandoori")
            {
                string d1 = "Chicken Patty";
                string d2 = "Korean Spices";
            ...
            else if (Dish3.Text == "Margherita Pizza")
            {
                string d1 = "Beef Patty";
                string d2 = "White Sauce";
                string d3 = "Flour";
            ...
            else if (Dish3.Text == "Thai Steamed Fish")
            {
                string d1 = "Fish";
                string d2 = "Korean Spices";
            ...
            else if (Dish3.Text == "Chicken Reshmi Kebab")
            {
                string d1 = "Chicken Patty";
                string d2 = "Vaults Secret Sauce";
            ...
            if (Dish4.Text == "Rumble Burger")
            {
                ...
                Int32.TryParse(Quantity4.Text, out q);
                q1 = q1 - q;
                q2 = q2 - q;
                q3 = q3 - q;
                q4 = q4 - q;
            ...
            else if (Dish4.Text == "Pomodoro Pasta")
            {
                string d1 = "Pasta";
                string d2 = "White Sauce";
                string d3 = "Vaults Secret Sauce";
            ...
            else if (Dish4.Text == "Korean Fried Chicken")
            {
                string d1 = "Chicken Patty";
                string d2 = "Korean Spices";
                string d3 = "Lettuce";
            ...
            else if (Dish4.Text == "Sicilian Pizza")
            {
                string d1 = "Flour";
                string d2 = "Cheese Sauce";
                string d3 = "Vaults Secret Sauce";
            ...
            else if (Dish4.Text == "White Cheese Chicken Lasagna")
            {
                string d1 = "Chicken Patty";
                string d2 = "White Sauce";
                string d3 = "Cheese Sauce";
            ...
            else if (Dish4.Text == "Chicken Tandoori")
            {
                string d1 = "Chicken Patty";
                string d2 = "Korean Spices";
            ...
            else if (Dish4.Text == "Margherita Pizza")
            {
                string d1 = "Beef Patty";
                string d2 = "White Sauce";
                string d3 = "Flour";
            ...
            else if (Dish4.Text == "Thai Steamed Fish")
            {
                string d1 = "Fish";
                string d2 = "Korean Spices";
            ...
            else if (Dish4.Text == "Chicken Reshmi Kebab")
            {
                string d1 = "Chicken Patty";
                string d2 = "Vaults Secret Sauce";
