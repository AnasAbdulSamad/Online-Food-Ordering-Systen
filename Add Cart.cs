...
namespace FoodApp
{
    public partial class Add_Cart : Form
    {
        ...
        private void button_plus_Click(object sender, EventArgs e)
        {
            ...
            else if (dish_name == "Korean Fried Chicken")
            {
            ...
            else if (dish_name == "Sicilian Pizza")
            {
                string d1 = "Flour";
            ...
            else if (dish_name == "White Cheese Chicken Lasagna")
            {
                string d1 = "Chicken Patty";
                string d2 = "White Sauce";
                ...
                int highest = Math.Min(q4, Math.Min(q1, Math.Min(q3, q2)));
                if (check_quantity < highest)
                {
                    check_quantity += 1;
                    label_quantity.Text = check_quantity.ToString();
            ...
            else if (dish_name == "Chicken Tandoori")
            {
                string d1 = "Chicken Patty";
                string d2 = "Korean Spices";
            ...
            else if (dish_name == "Margherita Pizza")
            {
                string d1 = "Beef Patty";
                string d2 = "White Sauce";
                string d3 = "Flour";
            ...
            else if (dish_name == "Thai Steamed Fish")
            {
                string d1 = "Fish";
                string d2 = "Korean Spices";
            ...
            else if (dish_name == "Chicken Reshmi Kebab")
            {
                string d1 = "Chicken Patty";
